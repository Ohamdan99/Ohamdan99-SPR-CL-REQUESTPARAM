...
public class SearchController {
     ...
     * if you are writing an endpoint intended to return some search results, it is conventional to include not
     ...
     * that refine how the backend should interact with the entity should be included as a path parameter.
     *
